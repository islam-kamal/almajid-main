...
class FavouriteListModel extends BaseMappable{
  bool status;
  int code;
  String msg;
  List<Data> data;

  FavouriteListModel({this.status, this.code, this.msg, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return FavouriteListModel(status: status,msg: msg,code: code,data: data);
  }
}
...
class Data {
  ...
  Data({this.id, this.product, this.user, this.createDates, this.updateDates});
