  ...
  runApp(MultiProvider(
    ...
    child: MaterialApp(
      ...
      theme: ThemeData(
          ...
          fontFamily: checkDirection(dirArabic: "Cairo", dirEnglish: "Cairo")),
...
class _MyAppState extends State<MyApp> {
  ...
  void get_Static_data() async {
    await sharedPreferenceManager
        .readString(CachingKey.USER_COUNTRY_CODE)
        .then((value) {
    ...
    await sharedPreferenceManager
        .readString(CachingKey.APP_LANGUAGE)
        .then((value) {
      if (value == '') {
          ...
          return KeyedSubtree(
            ...
            child: MaterialApp(
              ...
              theme: ThemeData(
                  ...
                  primaryColor: mainColor,
                  fontFamily:
                      checkDirection(dirArabic: "Cairo", dirEnglish: "Cairo")),
              title: 'Al Majed Oud',
              home: SplashScreen(),
