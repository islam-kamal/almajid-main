...
singleEditCartItem({BuildContext context , bool checkValue : false}){
      ...
      Column(
        children: [
          ...
          Neumorphic(child: Container(width: width(context)*.9 ,child: Row(children: [
            Container(width:
            width(context)*.1,height: isLandscape(context)
                ? 2*height(context)*.15 : height(context)*.15 , child: Center(child: Checkbox(value: checkValue,onChanged: (v){},),),
            ),
