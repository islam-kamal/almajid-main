...
customDescriptionText(context: context , text: "Edit Cart" , textColor: whiteColor ,
    fontWeight: FontWeight.bold , percentageOfHeight: .025),
//
            Row(
              children: [

                Image.asset("assets/icons/heart.png" , height:
                isLandscape(context) ?2*height(context)*.05 : height(context)*.05,),
                SizedBox(width: width(context)*.02,),

                Image.asset("assets/icons/delete.png" , height:
