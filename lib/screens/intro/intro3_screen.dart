    ...
    return Scaffold(
        ...
        body: Center(child: Stack(children: [
          Container(width: width(context),height: height(context),
            child: Image.asset("assets/images/intro3.png" , fit: BoxFit.cover,),),
          Container(width: width(context),height: height(context),
            child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Image.asset("assets/icons/intro3.png" , fit: BoxFit.contain,)),
              ],
            ),
          ),
          Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Column(
                          children: [
                            Row(children: [
                              GestureDetector(onTap: (){customAnimatedPushNavigation(context, SignInScreen());},
