...
import 'package:almajidoud/screens/intro/intro3_screen.dart';
    ...
    return Scaffold(
        ...
        body: Center(child: Stack(children: [
          Container(width: width(context),height: height(context),
            child: Image.asset("assets/images/intro2.png" , fit: BoxFit.cover,),),
          Container(width: width(context),height: height(context),
            child: Column(


              children: [
                responsiveSizedBox(context: context , percentageOfHeight: .7),
                Container(
                    width: width(context)*.7,
                    child: Image.asset("assets/icons/intro2.png" , fit: BoxFit.contain,)),
              ],
            ),
          ),
          Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Column(
                          children: [
                            Row(children: [
                              GestureDetector(onTap: (){customAnimatedPushNavigation(context, Intro3Screen());},
