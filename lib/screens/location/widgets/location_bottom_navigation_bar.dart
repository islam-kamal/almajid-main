             ...
             children: [
               ...
               Neumorphic(
                   style:  NeumorphicStyle(
                     ...
                     color: blackColor , depth:5,
                     shadowDarkColor: blackColor , lightSource: LightSource.bottom,
...
//
         ...
         MainAxisAlignment.spaceAround,mainAxisSize: MainAxisSize.min,
           children: [
             ...
             customBottomBarButton(context: context , isActive: true, icon: "assets/icons/location.png" ,title: "Location", onTap: (){
