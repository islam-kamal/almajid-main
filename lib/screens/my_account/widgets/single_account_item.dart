...
singleAccountItem({BuildContext context , String text , String iconPath , Function onTap , bool isContainMoreIcon : false }){
    ...
    child: Column(
      children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
          ...
          Icon(Icons.arrow_forward_ios , size:isLandscape(context) ?
          2*height(context)*.025 :height(context)*.025) : SizedBox()
