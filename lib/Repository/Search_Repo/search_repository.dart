...
class SearchRepository {
  ...
  Future<SearchModel> search_products_fun({String search_text}) async {
    ...
    return NetworkUtil.internal().get(
        SearchModel(),
        '${Urls.BASE_URL}/rest/V1/mstore/products?searchCriteria[filter_groups][0][filters][0][field]=name&searchCriteria[filter_groups][0][filters][0][value]=%${search_text}%&searchCriteria[filter_groups][0][filters][0][condition_type]=like',
